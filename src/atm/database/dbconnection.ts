...
export class DbConnection {
     ...
     private _userName   : string = "fzelaya";
     private _passWord   : string = "FZelaya12345";
     private _dbName     : string = "bbl_atm";
     private _hostName   : string = "ds117749.mlab.com";
     private _portNumber : string = "17749";
